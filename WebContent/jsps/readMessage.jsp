...
<script
  ...
  <style>
     <%@ include file="../resources/readMessage.css"%>
</style> 
						...
						<div id="messages">
							<table>
								<tr>
									<td>Sender</td>
									<td colspan="3" ><c:out
												value="${ message.sender }"></c:out></td>
								</tr>
								<tr>
									<td>Subject</td>
									<td colspan="3" ><c:out
												value="${ message.subject }"></c:out></td>
								</tr>
								<tr>
									<td>Date</td>
									<td colspan="3"><c:out
												value="${ message.dateAsString }"></c:out></td>
								</tr>
								<tr>
									<td>Message</td>
									<td colspan="3"><c:out
							...
							<div class="form-group">
								<div class="btn-group ">
									<button class="btn btn-success">
										<a href="../reply/${ message.sender }/${ message.subject }.htm">&nbsp;Answer&nbsp;</a>
									</button>
									<!-- <button class="btn btn-info">
										<a href="#">Forward</a>
									</button> -->
									<button class="btn btn-danger"  >
										<a href="../trash/${ message.id }.htm">Delete</a>
									</button>
								</div>
							</div>
						</div>
